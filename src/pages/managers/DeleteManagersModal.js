...
import { actionAddManagers, actionDeleteManagers, actionEditManagers } from "./ManagersAction";

function DeleteManagersModal(props) {
  const { visible, onCancel, item = {}, handleFetchManagers } = props;
  const onSummit = async () => {
    await actionDeleteManagers(item.id);
