...
import { actionAddMidTerms, actionEditMidTerms } from "./MidTermsAction";

function EditMidTermsModal(props) {
  ...
  const onSummit = async () => {
    ...
    if (isAddNew) {
        await actionAddMidTerms(data);
        toastSuccess("Thêm mới điểm danh thành công")
      } else {
        await actionEditMidTerms(data, item?.id);
...
export default EditMidTermsModal;
