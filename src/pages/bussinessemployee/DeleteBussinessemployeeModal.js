...
import { actionAddBussinessemployee, actionDeleteBussinessemployee, actionEditBussinessemployee } from "./BussinessemployeeAction";

function DeleteBussinessemployeeModal(props) {
  const { visible, onCancel, item = {}, handleFetchBussinessemployee } = props;
  const onSummit = async () => {
    await actionDeleteBussinessemployee(item.id);
...
export default DeleteBussinessemployeeModal;
