  ...
  return (
    <div className="invoice-list-table-header w-100 py-2">
      <Row>
        ...
        <Col
          lg="6"
          className="actions-right d-flex align-items-bussinessemployee justify-content-lg-end flex-lg-nowrap flex-wrap mt-lg-0 mt-1 pr-lg-1 p-0"
        >
          <div className="d-flex align-items-bussinessemployee">
            ...
            <Input
              ...
              placeholder="Tìm kiếm tên nhân viên kinh doanh"
            />
          </div>
          {/* <Input
            className="w-auto "
...
//   }, [dispatch, store.data.length]);
  ...
  const CustomPagination = () => {
    const count = Number((bussinessemployees.count / rowsPerPage).toFixed(0));
    return (
      <ReactPaginate
        pageCount={count || 1}
        nextLabel=""
  ...
  return (
    <Fragment>
      <Breadcrumbs breadCrumbTitle="Nhân viên kinh doanh" />
        ...
        <Card>
          <div className="invoice-list-dataTable">
            <DataTable
              ...
              data={bussinessemployees.results}
              subHeaderComponent={
                <CustomHeader
      ...
      {visibleModal && (
        <AddOrEditBussinessemployeeModal
