...
const ToastContent = ({ name, role }) => (
  <Fragment>
    ...
    <div className='toastify-body'>
      <span>You have successfully logged in as an {role} user to Odin. Now you can start to explore. Enjoy!</span>
    </div>
  </Fragment>
)
...
const Login = props => {
  ...
  const [password, setPassword] = useState('123456c@')
    ...
    <div className='auth-wrapper auth-v2'>
      <Row className='auth-inner m-0'>
        <Link className='brand-logo' to='/' onClick={e => e.preventDefault()}>
          ...
          <h2 className='brand-text text-primary ml-1'>Odin</h2>
        </Link>
