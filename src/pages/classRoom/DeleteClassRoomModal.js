...
import { actionAddClassRoom, actionDeleteClassRoom, actionEditClassRoom } from "./ClassRoomAction";

function DeleteClassRoomModal(props) {
  const { visible, onCancel, item = {}, handleFetchClassRoom } = props;
  const onSummit = async () => {
    await actionDeleteClassRoom(item.id);
