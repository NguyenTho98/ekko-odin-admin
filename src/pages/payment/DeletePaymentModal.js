...
import { actionAddPayment, actionDeletePayment, actionEditPayment } from "./PaymentAction";

function DeletePaymentModal(props) {
  const { visible, onCancel, item = {}, handleFetchPayment } = props;
  const onSummit = async () => {
    await actionDeletePayment(item.id);
